...
class _PageLatVideoState extends State<PageLatVideo> {
  ...
  Future<void> _fetchVideoData() async {
    try {
      final response = await http.get(Uri.parse('http://192.168.100.137/listvideo/getVideo.php'));
                ...
                Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) => VideoPlayerPage(
                      videoUrl: 'http://192.168.100.137/listvideo/video_file/${_videoList[index].videoFile}',
              ...
              child: Row(
                children: [
                  _videoList[index].gambar.isNotEmpty
                    ...
                    child: Image.network(
                      'http://192.168.100.137/listvideo/gambar/${_videoList[index].gambar}',
                      width: 100,
                      height: 100,
                      fit: BoxFit.cover,
                    ),
